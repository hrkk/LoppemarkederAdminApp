<table>
    <tr>
        <td colspan="2">
        Marked <a href="http://roninit.dk/LoppemarkederAdminApp/show/${marked.id}"> ${marked}</a> er oprettet fra mobil appen. Markedet er aktiveret og kan se i markeds oversigten.
