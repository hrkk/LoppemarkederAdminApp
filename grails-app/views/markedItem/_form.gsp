...
<div class="fieldcontain ${hasErrors(bean: markedItemInstance, field: 'toDate', 'error')} required">
	<label for="toDate">
		<g:message code="markedItem.toDate.label" default="To Date" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="toDate" precision="day"  value="${markedItemInstance?.toDate}"  />
</div>
...
<div class="fieldcontain ${hasErrors(bean: markedItemInstance, field: 'latitude', 'error')} required">
	...
	<g:field name="latitude" value="${fieldValue(bean: markedItemInstance, field: 'latitude')}" required=""/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: markedItemInstance, field: 'longitude', 'error')} required">
	...
	<g:field name="longitude" value="${fieldValue(bean: markedItemInstance, field: 'longitude')}" required=""/>
</div>
