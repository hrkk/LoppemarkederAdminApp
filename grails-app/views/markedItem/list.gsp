...
<body>
<a href="#list-markedItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-markedItem" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="address"
                              title="${message(code: 'markedItem.address.label', default: 'Address')}"/>

            <g:sortableColumn property="fromDate"
                              title="${message(code: 'markedItem.fromDate.label', default: 'From Date')}"/>

            <g:sortableColumn property="toDate"
                              title="${message(code: 'markedItem.toDate.label', default: 'To Date')}"/>

            <g:sortableColumn property="dateExtraInfo"
                              title="${message(code: 'markedItem.dateExtraInfo.label', default: 'Date Extra Info')}"/>

            <g:sortableColumn property="entreInfo"
                              title="${message(code: 'markedItem.entreInfo.label', default: 'Entre Info')}"/>
        ...
        <g:each in="${markedItemInstanceList}" status="i" var="markedItemInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${markedItemInstance.id}">${fieldValue(bean: markedItemInstance, field: "name")}</g:link></td>
    ...
    <div class="pagination">
        <g:paginate total="${markedItemInstanceTotal}"/>
    </div>
</div>
</body>
</html>
